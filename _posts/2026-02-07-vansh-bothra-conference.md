...
<div style="display: flex; gap: 20px; justify-content: center; margin: 30px 0;">
  ...
  <figure style="text-align: center; width: 45%;">
    <img src="/photos/vansh1.jpg" alt="Vansh at the MobileHCI venue" style="width: 100%; border-radius: 8px;">
    <figcaption>Vansh at the MobileHCI Conference venue in Sharm-El-Sheikh.</figcaption>
  </figure>

  <figure style="text-align: center; width: 45%;">
    <img src="/photos/vansh3.jpg" alt="Vansh presenting his research" style="width: 100%; border-radius: 8px;">
    <figcaption>Red Sea, Egypt</figcaption>
  </figure>
